...
# Calculate new capacitor and resistor values for retuned version
# of YuSynth fixed filter bank
#
# New frequencies are lpf, bpf[], and hpf.
...
tdhas = [0.,
         ...
         1000., 1500.]
stdr = [0.100, 0.120, 0.150, 0.180, 0.220, 0.270,
        0.330, 0.390, 0.470, 0.560, 0.680, 0.820,
        1.000, 1.200, 1.500, 1.800, 2.200, 2.700,
        3.300, 3.900, 4.700, 5.600, 6.800, 8.200,
        10.00, 12.00, 15.00, 18.00, 22.00, 27.00,
        33.00, 39.00, 47.00, 56.00, 68.00, 82.00,
        100.0, 120.0, 150.0, 180.0, 220.0, 270.0,
        330.0, 390.0, 470.0, 560.0, 680.0, 820.0]

### Usson
#lpf = 88.    # low pass freq
#bpf = [125., 175., 250., 350., 500., 750.,
#1000., 1400., 2000., 2800., 4000., 5600.] # band pass freqs
#hpf = 7000.  # high pass freq

### AO
lpf = 85.5    # low pass freq
bpf = [125., 185., 265., 390., 570., 830.,
       1200., 1750., 2600., 3800., 5500., 8050.] # band pass freqs
hpf = 11500.  # high pass freq

roldnew = {'C1a': 'C25', 'C1b': 'C27', 'C2a': 'C29', 'C2b': 'C30',
           'C3a': 'C33', 'C3b': 'C35', 'C4a': 'C37', 'C4b': 'C38',
           'C5a': 'C26', 'C5b': 'C28', 'C6a': 'C31', 'C6b': 'C32',
           'C7a': 'C34', 'C7b': 'C36', 'C8a': 'C39', 'C8b': 'C40',
           'C9a': 'C41', 'C9b': 'C43', 'C10a': 'C45', 'C10b': 'C46',
           'C11a': 'C49', 'C11b': 'C51', 'C12a': 'C53', 'C12b': 'C54',
           'C13a': 'C42', 'C13b': 'C44', 'C14a': 'C47', 'C14b': 'C48',
           'C15a': 'C50', 'C15b': 'C52', 'C16a': 'C55', 'C16b': 'C56',
           'C17a': 'C57', 'C17b': 'C59', 'C18a': 'C61', 'C18b': 'C62',
           'C19a': 'C65', 'C19b': 'C67', 'C20a': 'C69', 'C20b': 'C70',
           'C21a': 'C58', 'C21b': 'C60', 'C22a': 'C63', 'C22b': 'C64',
           'C23a': 'C66', 'C23b': 'C68', 'C24a': 'C71', 'C24b': 'C72',
           'C25a': 'C73', 'C25b': 'C75', 'C26a': 'C77', 'C26b': 'C78',
           'C27a': 'C81', 'C27b': 'C83', 'C28a': 'C85', 'C28b': 'C86',
           'C29a': 'C74', 'C29b': 'C76', 'C30a': 'C79', 'C30b': 'C80',
           'C31a': 'C82', 'C31b': 'C84', 'C32a': 'C87', 'C32b': 'C88',
           'C33a': 'C89', 'C33b': 'C91', 'C34a': 'C93', 'C34b': 'C94',
           'C35a': 'C97', 'C35b': 'C99', 'C36a': 'C101', 'C36b': 'C102',
           'C37a': 'C90', 'C37b': 'C92', 'C38a': 'C95', 'C38b': 'C96',
           'C39a': 'C98', 'C39b': 'C100', 'C40a': 'C103', 'C40b': 'C104',
           'C41a': 'C105', 'C41b': 'C107', 'C42a': 'C109', 'C42b': 'C110',
           'C43a': 'C113', 'C43b': 'C115', 'C44a': 'C117', 'C44b': 'C118',
           'C45a': 'C106', 'C45b': 'C108', 'C46a': 'C111', 'C46b': 'C112',
           'C47a': 'C114', 'C47b': 'C116', 'C48a': 'C119', 'C48b': 'C120',
           'C49a': 'C122', 'C49b': 'C123', 'C50a': 'C124', 'C50b': 'C126',
           'C51a': 'C128', 'C51b': 'C129', 'C52a': 'C130', 'C52b': 'C132'}

roldnewr = {'R78a': 'R83', 'R78b': 'R85', 'R79a': 'R87', 'R79b': 'R86',
            'R80a': 'R89', 'R80b': 'R91', 'R81a': 'R93', 'R81b': 'R92'}
